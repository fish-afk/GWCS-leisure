INSERT INTO Users (username, password, email, firstname, surname, DOB, usertype) 
        VALUES 
...
INSERT INTO Pitches (site_id, Pitch_Type) 
                VALUES 
                (1, 1),
                (1, 2),
                (1, 3),
...
INSERT INTO LocalAttractions(attraction_name, description, milesFromSite, site_id, image_url, price) VALUES ('Bourkes Luck Potholes', 'A scenic geological formation on the Blyde River', 20.5, 1, 'https://example.com/bourkes-luck-potholes.jpg', 12.50),
