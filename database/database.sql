...
-- Dumping data for table gwcs_shihab_mirza.done: ~1 rows (approximately)
INSERT INTO `done` (`isdone`) VALUES
	(1),
	(1),
	(1);
...
INSERT INTO `localattractions` (`id`, `attraction_name`, `description`, `milesFromSite`, `site_id`, `price`) VALUES
	...
	(9, 'Robberg Nature Reserve', 'Explore the natural beauty of the South African coastline with a visit to Robberg Nature Reserve. Located near Plettenberg Bay, the reserve offers scenic hiking trails with stunning views of the ocean and surrounding landscape. Visitors can spot a variety of wildlife, including seals, dolphins, and birds, and can even take a dip in the ocean at one of the reserves many beaches. With its rugged beauty and diverse ecosystem, Robberg Nature Reserve is a must-visit destination for nature lovers.', 2.5, 10, 7),
	(10, 'Cango Caves', 'Discover the otherworldly beauty of the Cango Caves, a network of limestone caves located in the Western Cape of South Africa. The caves were formed millions of years ago and offer a unique and fascinating glimpse into the regions geological history. Visitors can take guided tours of the caves and marvel at their stunning stalactites and stalagmites. With its otherworldly beauty and fascinating history, the Cango Caves are a must-see attraction for anyone visiting the region.', 15, 7, 20),
	(11, 'Kirstenbosch National Botanical Garden', 'Located on the eastern slopes of Table Mountain, Kirstenbosch National Botanical Garden is a stunning collection of indigenous South African flora. Visitors can explore the diverse gardens and landscapes, take in the views of the city and surrounding mountains, and enjoy events and concerts held in the garden.', 5, 8, 12),
	(12, 'Lions Head Hike', 'One of the most popular hiking trails in Cape Town, the Lions Head Hike offers breathtaking views of the city, the Atlantic Ocean, and Table Mountain. The trail is moderate in difficulty and takes about two hours to complete, including time to enjoy the views from the summit.', 3, 11, 5),
	(13, 'Aurora Borealis Observatory', 'Located in the heart of Iceland, the Aurora Borealis Observatory is a unique and breathtaking destination for stargazing enthusiasts. Visitors can take guided tours and learn about the Northern Lights and other astronomical phenomena, while enjoying stunning views of the night sky.', 5, 6, 30),
	(14, 'Skaftafell Glacier Hike', 'Explore the stunning beauty of Iceland with a guided hike on the Skaftafell Glacier, located in Skaftafell National Park. The hike takes visitors through an otherworldly landscape of ice formations and volcanic terrain, while providing unparalleled views of the surrounding mountains and valleys.', 1, 5, 75),
	(15, 'Wildlife Photography Tour in South Luangwa National Park', 'Embark on a guided photography tour of the diverse and abundant wildlife of South Luangwa National Park. Visitors will have the opportunity to capture stunning images of elephants, lions, leopards, giraffes, and other wildlife, while learning about the ecology and conservation efforts of the park.', 2.5, 4, 40);
...
-- Dumping data for table gwcs_shihab_mirza.loginattempts: ~0 rows (approximately)
...
-- Dumping data for table gwcs_shihab_mirza.messages: ~0 rows (approximately)
...
-- Dumping data for table gwcs_shihab_mirza.pitches: ~25 rows (approximately)
INSERT INTO `pitches` (`id`, `site_id`, `Pitch_Type`) VALUES
	(1, 1, 1),
	(2, 1, 2),
	(3, 1, 3),
	(4, 1, 2),
...
-- Dumping data for table gwcs_shihab_mirza.reviews: ~0 rows (approximately)
...
-- Dumping data for table gwcs_shihab_mirza.swimmingsessions: ~10 rows (approximately)
INSERT INTO `swimmingsessions` (`id`, `site_id`, `Start`, `End`, `price`) VALUES
	(1, 2, '09:00:00', '10:00:00', 15),
	(2, 4, '14:00:00', '15:30:00', 20.5),
	(3, 8, '12:00:00', '13:30:00', 18),
	(4, 10, '08:30:00', '09:30:00', 12.5),
	(5, 1, '10:00:00', '11:30:00', 22),
	(6, 3, '13:00:00', '14:30:00', 17.5),
	(7, 6, '11:00:00', '12:00:00', 10),
	(8, 7, '16:00:00', '17:00:00', 12.5),
	(9, 9, '15:00:00', '16:30:00', 21.5),
	(10, 5, '07:30:00', '08:30:00', 8);
...
-- Dumping data for table gwcs_shihab_mirza.users: ~5 rows (approximately)
INSERT INTO `users` (`username`, `password`, `email`, `firstname`, `surname`, `DOB`, `usertype`) VALUES
